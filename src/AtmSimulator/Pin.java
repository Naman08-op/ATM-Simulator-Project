...
public class Pin extends JFrame implements ActionListener{
    ...
    Pin(){
        ...
        l2.setFont(new Font("Dialog", Font.BOLD, 22));
        
        l3 = new JLabel("New PIN:");
        l3.setFont(new Font("Dialog", Font.BOLD, 22));
        
        l4 = new JLabel("Re-Enter New PIN:");
        l4.setFont(new Font("Dialog", Font.BOLD, 22));
        
        t1 = new JPasswordField();
        t1.setFont(new Font("Dialog", Font.BOLD, 22));
        
        t2 = new JPasswordField();
        t2.setFont(new Font("Dialog", Font.BOLD, 22));
        
        t3 = new JPasswordField();
        t3.setFont(new Font("Dialog", Font.BOLD, 22));
